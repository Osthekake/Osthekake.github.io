	...
	const timelineItems = useMemo(() => (
		[
            ...
            },
            {
                ...
                title: "Angular Smith",
                badges: ["angular", "typescript", "rxjs", "piskel"],
                date: "2022-06-13",
                category: "Other Project",
                screenshots: [
                    {
            ...
            },
            {
                ...
                badges: ["angular", "typescript", "rxjs"],
                date: "2022-06-20",
                category: "Other Project",
                screenshots: [
                    {
	...
	return (
		<div className="container">
			<div className="jumbotron">
				...
				<p className="lead">Ludum Dare is a 48 hour game jam that happens globally, three times a year. Participants have to create an entire game by themselves in 48 hours. In later years, I have joined the 72 hour jam, which encourages collaboration.</p>
